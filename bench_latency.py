...
测三档: baseline / dual N=2 / dual no-refresh。
...
def set_cfg(partial, attn, refresh_n):
...
# ---- 理论 FLOPs 比例 (来自前面的模型, large d=1024 s=576) ----
...
print(f"{'config':16s} {'total ms/img':>13s} {'transf ms/img':>14s} "
...
for name, kw in CONFIGS:
    ...
    print(f"{name:16s} {total_ms:11.2f}   {transf_ms:12.2f}   "
