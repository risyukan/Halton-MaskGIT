"""生成示例图: layer-output cache, layer 全开 (0..23), cache-refresh N=4。

与 generate_layercache_N2.py 的区别:
  - HALTON_CACHE_REFRESH_N=4  (每 4 个 gated step 刷新一次, ~7/26 refresh)
  - HALTON_PARTIAL_START/END_LAYER=0/23 (large 24 层全部走 layer cache)
对应 FID 评测: launch/eval_fid_large384_layercache_alllayers_N4.sh
  (FID 3.182 / IS 238.7, 理论 FLOPs 加速 1.89x)
...
os.environ["HALTON_CACHE_REFRESH_N"] = "4"
...
out = "gen_layercache_N4_alllayers.png"
