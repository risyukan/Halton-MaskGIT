#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 5 gated steps (6/26 refresh (23%))
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N5.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=5 -> $LOG"
