#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 3 gated steps (9/26 refresh ~35%)
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N3.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=3 -> $LOG"
