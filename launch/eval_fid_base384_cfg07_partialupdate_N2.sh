#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 2 gated steps (13/26 refresh)
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N2.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=2 -> $LOG"
