#!/usr/bin/bash
# Small-384 / cfg=1.0 sweep — partial_update=True, refresh every 8 gated steps (4/26 refresh (15%))
...
LOG=/tmp/eval_fid_small384_cfg10_partialupdate_N8.log
echo "[$(date '+%F %T')] start small384 cfg=1.0 N=8 -> $LOG"
