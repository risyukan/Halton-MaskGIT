#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 7 gated steps (4/26 refresh (15%))
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N7.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=7 -> $LOG"
