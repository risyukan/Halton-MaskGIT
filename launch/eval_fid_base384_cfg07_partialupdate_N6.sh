#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 6 gated steps (5/26 refresh (19%))
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N6.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=6 -> $LOG"
