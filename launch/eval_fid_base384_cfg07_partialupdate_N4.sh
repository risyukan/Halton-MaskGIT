#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 4 gated steps (7/26 refresh ~27%)
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N4.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=4 -> $LOG"
