#!/usr/bin/bash
# Base-384 / cfg=0.7 sweep — partial_update=True, refresh every 9 gated steps (3/26 refresh (12%))
...
LOG=/tmp/eval_fid_base384_cfg07_partialupdate_N9.log
echo "[$(date '+%F %T')] start base384 cfg=0.7 N=9 -> $LOG"
