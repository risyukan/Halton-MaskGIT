#!/usr/bin/bash
# Small-384 / cfg=1.0 sweep — partial_update=True, refresh every 2 gated steps (13/26 refresh (50%))
...
LOG=/tmp/eval_fid_small384_cfg10_partialupdate_N2.log
echo "[$(date '+%F %T')] start small384 cfg=1.0 N=2 -> $LOG"
